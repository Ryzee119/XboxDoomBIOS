...
// clang-format off
const uint8_t XCALIBUR_OFFSETS[] =
...
static const uint8_t CONEXANT_OFFSETS[] =
...
const uint32_t CONEXANT_MODES[] =
                  {0x04010101,0x04020202,0x04010103,0x04020204,0x0401010b,0x0402020c,0x0801010d,0x0802020e,0x08010119,0x0802021a,0x44030307,0x44040408,0x48030314,0x48040415,0x20010101,0x20020202,0x20010103,0x20020204,0x2001010b,0x2002020c,0x60030307,0x60040408};
...
void xbox_encoder_configure(uint32_t mode_coding, display_information_t *display_info)
{
    ...
    const uint8_t current_encoder_address = display_info->current_encoder_address;
